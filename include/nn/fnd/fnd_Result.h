...
namespace fnd{
    ...
    NN_DEFINE_RESULT_CONST(MakeResultAlreadyListed,Result::LEVEL_USAGE, Result::SUMMARY_INVALID_ARGUMENT, Result::MODULE_NN_FND, nn::fnd::DESCRIPTION_ALREADY_LISTED);
